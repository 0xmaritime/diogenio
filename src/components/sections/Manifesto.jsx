    ...
    <section className="py-32 bg-[var(--color-paper)]">
      <div className="max-w-4xl mx-auto px-8">
        <div className="border-l-2 border-[var(--color-gold)] pl-8">
          <h2 className="font-display text-5xl mb-12 text-[var(--color-black)] leading-tight">
          ...
          <div className="space-y-8">
            ...
            <blockquote className="border-l-4 border-[var(--color-sage)] pl-6 py-2">
              <p className="font-display text-xl italic text-[var(--color-text-primary)]">
