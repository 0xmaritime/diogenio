...
export default function Footer() {
  return (
    <footer className="py-16 bg-[var(--color-dark-eyes)] relative overflow-hidden"> {/* Dark Brown background */}
...
`}
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="terminal-box bg-[var(--color-card-dark-opacity)] border border-[var(--color-dark-brown-opacity-30)] p-4 rounded-lg"> {/* Dark Brown bg and border */}
          ...
          <div className="terminal-box bg-[var(--color-card-dark-opacity)] border border-[var(--color-dark-brown-opacity-30)] p-4 rounded-lg">
            ...
            <div className="grid grid-cols-2 gap-3 font-mono text-sm">
              ...
              <a href="/gallery" className="text-[var(--color-text-secondary)] hover:text-[var(--color-accent-1)] transition-colors">
                <span className="text-[var(--color-text-secondary)]/70 mr-2">$</span>
                cd /gallery
              </a>
              <a href="/elements" className="text-[var(--color-text-secondary)] hover:text-[var(--color-accent-1)] transition-colors">
                <span className="text-[var(--color-text-secondary)]/70 mr-2">$</span>
                cd /elements
              </a>
              <a href="/lore" className="text-[var(--color-text-secondary)] hover:text-[var(--color-accent-1)] transition-colors">
                <span className="text-[var(--color-text-secondary)]/70 mr-2">$</span>
                cd /lore
              </a>
              <a href="/about" className="text-[var(--color-text-secondary)] hover:text-[var(--color-accent-1)] transition-colors">
                <span className="text-[var(--color-text-secondary)]/70 mr-2">$</span>
                cd /about
              </a>
              <a href="/faq" className="text-[var(--color-text-secondary)] hover:text-[var(--color-accent-1)] transition-colors">
                <span className="text-[var(--color-text-secondary)]/70 mr-2">$</span>
                cd /faq
              </a>
            </div>
        ...
        <div className="mt-12 pt-8 border-t border-[var(--color-dark-brown-opacity-30)] text-center"> {/* Dark Brown border */}
          <div className="inline-block bg-[var(--color-dark-eyes)] border border-[var(--color-dark-brown-opacity-30)] px-3 py-1 font-mono text-xs text-[var(--color-text-secondary)]/70"> {/* Dark Brown bg, Dark Brown border, Warm Gray text */}
